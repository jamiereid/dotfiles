...
Sometimes you might need to delete the org byte compiled files after changing the =org-babel-do-load-languages= var.
#+BEGIN_SRC sh
rm ~/.emacs.d/elpa/org-<date>/*.elc
#+END_SRC
...
(use-package color-theme
  ...
  :config (use-package color-theme-molokai
           :ensure t))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(jr/change-theme 'color-theme-molokai 'org-src-color-blocks-dark)
