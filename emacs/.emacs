...
; rust rls::   rustup component add rls rust-analysis rust-src
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flymake flymake-rust flymake-checkers eglot csv-mode doom-themes doom-modeline all-the-icons projectile neotree org-bullets racer flycheck-rust cargo rust-mode git-gutter-fringe magit org-pdfview zenburn-theme csharp-mode gruvbox-theme use-package diminish))))
(custom-set-faces
